...
(
    ...
    CONSTRAINT pk_src_view_cols PRIMARY KEY (table_name, column_name)
);

CREATE TABLE tgt_view_cols
(
    table_name varchar(128) not null,
    column_name varchar(128) not null,
    data_type varchar(128),
    ...
    identity_column varchar(3),
    collation varchar(100),
    CONSTRAINT pk_tgt_view_cols PRIMARY KEY (table_name, column_name)
);
