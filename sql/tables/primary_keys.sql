...
(
    ...
    CONSTRAINT pk_src_primary_keys PRIMARY KEY (table_name, constraint_name)
);

CREATE TABLE tgt_primary_keys
(
    constraint_name varchar(128) not null,
    -- constraint_type varchar(1),
    table_name varchar(128) not null,
    ...
    invalid varchar(7),
    view_related varchar(14),
    CONSTRAINT pk_tgt_primary_keys PRIMARY KEY (table_name, constraint_name)
);
