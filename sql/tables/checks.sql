...
(
    ...
    CONSTRAINT pk_src_checks PRIMARY KEY (table_name, constraint_name)
);

CREATE TABLE tgt_checks
(
    constraint_name varchar(128) not null,
    -- constraint_type varchar(1),
    table_name varchar(128) not null,
    ...
    invalid varchar(7),
    view_related varchar(14),
    CONSTRAINT pk_tgt_checks PRIMARY KEY (table_name, constraint_name)
);
