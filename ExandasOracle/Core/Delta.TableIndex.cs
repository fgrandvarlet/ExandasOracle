			...
			using (FbDataReader dr = cmd.ExecuteReader())
			{
				while (dr.Read())
				{
					var sourceTableIndex = new TableIndex
					{
						...
						PrefixLength = dr["src_prefix_length"] is DBNull ? null : (decimal?)dr["src_prefix_length"],
						TablespaceName = dr["src_tablespace_name"] is DBNull ? null : (string)dr["src_tablespace_name"],
						IncludeColumn = dr["src_include_column"] is DBNull ? null : (decimal?)dr["src_include_column"],
					...
					var targetTableIndex = new TableIndex
					{
						...
						PrefixLength = dr["tgt_prefix_length"] is DBNull ? null : (decimal?)dr["tgt_prefix_length"],
						TablespaceName = dr["tgt_tablespace_name"] is DBNull ? null : (string)dr["tgt_tablespace_name"],
						IncludeColumn = dr["tgt_include_column"] is DBNull ? null : (decimal?)dr["tgt_include_column"],
